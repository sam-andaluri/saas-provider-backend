#https://github.com/brightsparklabs/appcli/blob/3408b54482bfb4164c0c28ed331d4ae083e22315/appcli/keycloak_manager.py

from keycloak import KeycloakAdmin
import os

CLIENT_SECRET_KEY = os.environ.get("KEYCLOAK_MASTER_CLIENT_SECRET")
keycloak_admin = KeycloakAdmin(server_url="http://iam.saas-provider.cloud:8080/", client_id="python-sdk", realm_name="master", client_secret_key=CLIENT_SECRET_KEY, verify=True)
keycloak_admin.delete_realm(realm_name="demo")
keycloak_admin.create_realm(payload={"realm": "demo", "enabled": "true", "userManagedAccessAllowed": "true"}, skip_exists=False)
